...
if in_notebook_mode:
    ...
    create_scatter_of_backup_of_component(heads = [(5,1)]) # the head in gpt2-small which has insane downstream impact
    ablated_de, ablated_layer_de = dir_effects_from_sample_ablating(attention_heads=[(5,1)])
